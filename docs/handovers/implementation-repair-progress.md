...
| S19 … S21 | in progress (concurrent worktrees) | |
...
the plan schedules is closed except **S19…S21**; **S18 is done** — D1 was
answered and is implemented (ADR-076), and RT-13 gave a runtime enum its nominal
identity (ADR-074).
...
the repair is **S19…S21**; S18 closed the session after.
...
**`RUNTIME_ABI_VERSION` is 14.** S18 spent the bump; S19…S21 have none.
