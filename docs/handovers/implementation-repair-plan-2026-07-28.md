...
REP-58 and REP-60's stdin half, plus the `_sub`/`_mul` half of REP-46.** No
number is given here on
...
its `--input` half is fixed. **Everything else in this register is done.**
...
fix. **The register runs to REP-59 now.** REP-26 … REP-34 came from reading the
