...
**Four rows are open: REP-48, REP-49, REP-50 and REP-51** — REP-48/REP-49
registered by S20's repair pass, REP-50/REP-51 by its third review — and all
four **not done**. Everything before them is done.
...
for REP-50 and REP-51 — see the note at the top of this section.
