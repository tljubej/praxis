...
**Two rows are open: REP-48 and REP-49**, both registered by S20's repair pass
and both **not done**. Everything before them is done.
...
time. The register reopened once, for REP-48 and REP-49 — see the note at the
top of this section.
